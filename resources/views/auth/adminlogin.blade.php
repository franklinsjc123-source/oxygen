                    ...
                    <div class="col-md-5 m-auto p-0">
                        <div class="card" style="border-radius: 20px; overflow: hidden; border: none; box-shadow: 0 15px 35px rgba(0,0,0,0.3);">
                            <div class="card-body" style="background: #ffffff; padding: 30px 40px; color: #333;">
                                ...
                                @endif
                                <h3 class="text-center mb-4" style="font-weight: 700; letter-spacing: 1px; text-transform: uppercase; font-size: 1.5rem; color: #2d3436;">Admin Portal</h3>
                                ...
                                <form action="{{ route('adminlogin') }}" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Enter admin username" required style="border-radius: 10px; padding: 12px 15px; border: 1px solid #ddd; background: #f9f9f9; color: #333; font-size: 1.2rem;">
                                    </div>
                                    ...
                                    <div class="form-group mb-3 position-relative">
                                        ...
                                        <div style="position: relative;">
                                            <input type="password" class="form-control" id="pwd" name="password" placeholder="Enter admin password" required style="border-radius: 10px; padding: 12px 45px 12px 15px; border: 1px solid #ddd; background: #f9f9f9; color: #333; font-size: 1.2rem;">
