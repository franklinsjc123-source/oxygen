...
<?php                                                   // dd($products->vendor_product_details_cnt);?>
                                                <td class="text-center">
                                                    <span class="fw-bold">
                                                        <a href="#" data-id={{ $products->id }}
                                                            class="text-danger productDetails" data-bs-toggle="modal"
                                                            data-original-title="test"
                                                            data-bs-target="#stockModal">{{ $products->vendor_product_details_cnt }}</a>
                                                    </span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="mt-2 d-flex">
                                                        <a href="{{ route('vendorproducts.crud.view', ['id'=>$products->id, 'vendor_id'=> $vendorid]) }}"
