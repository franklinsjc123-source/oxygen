                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <input type="text" class="js-select2 form-control" name="speci_value[]" id="speci_value" >
                                                                                <datalist class="js-select2 form-control" name="speci_value[]"
                                                                                id="speci_value" >
