                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            <li class="breadcrumb-item"><a href="{{ route('vendordashboard', session()->get('login_id')) }}"><i data-feather="home"></i></a></li>
                                                ...
                                                <td>
                                                    @if(strtolower($item->status) === 'pending')
                                                        <div class="d-flex gap-2">
                                                            <form action="{{ route('vendor.returns.status', $item->id) }}" method="POST" id="approve-form-{{ $item->id }}">
                                                                @csrf
                                                            ...
                                                            <form action="{{ route('vendor.returns.status', $item->id) }}" method="POST" id="reject-form-{{ $item->id }}">
                                                                @csrf
