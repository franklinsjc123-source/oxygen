                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post"
                                                        action="{{ route('vendorcategory.main.store') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="d-flex">
                                                            ...
                                                            <!--<a href="{{ route('category.main.edit', $categories->id) }}" class="btn btn-secondary mx-1"-->
                                                            <!--    data-bs-toggle="modal" data-original-title="test"-->
                                                            <!--    data-bs-target="#exampleModal"data-original-title="Edit"><i-->
                                                            <!--        class="fa fa-pencil"></i>-->
                                                            <!--</a>-->
                                                            <form
                                                                action="{{ route('vendorcategory.main.destroy', $categories->id) }}"
                                                                method="post">
                                                                @method('DELETE')
                                                                @csrf
...
$(document).on('click','.edit_category_main', function(e){
    ...
    var url ="{{route('vendorcategory.main.edit', ":cate_id")}}";
          ...
          success: function (response) {
            ...
            //  alert(response);
                ...
                $('successmessage').text(response.message);
                    ...
                    // alert(response.category_main);
                    // console.log(response.category_main);
    ...
    $(document).on('submit','#updatecate', function(e){
        ...
        var url ="{{route('vendorcategory_main_update', ":updatecate_id")}}";
