                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Slider</h5>
									...
									<div class="form-group row"  >
											...
											<label class="">End Time</label>
												 <input type="time" value="00:00" class="form-control"   />
                                                             ...
                                                             <div class="form-group">
                                                                <label for="validationCustom01" class="mb-1">Marketing Cost :</label>
                                                                <input class="form-control" id="" type="text" required="true">
                                                            </div>
															<div class="form-group">
                                    ...
                                    <thead>
                                     <tr>
                                       <th data-field="id" data-sortable="true">Id</th> 
                                        ...
                                        <th data-field="sort" data-sortable="true">Marketing cost</th>
