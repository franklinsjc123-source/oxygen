...
if(+quantity >= +lowstack)
{
    ...
    $('#lowstack'+ind).html('<p style="color:green">Maximum quantity</p>');
     
}
else{
    
    $('#lowstack'+ind).html('<p style="color:red">Minimum quantity</p>');
}
...
$(document).on("click", ".remove_field", function(e) { //user click on remove text
  ...
  //  alert(pid);
     let url = '{{ route('productsdetailsdelete') }}?id=' + pid;
//  alert(url);
      let method = 'POST';
