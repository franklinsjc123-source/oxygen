                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                             ...
                                             <div class="row">
                                                 ...
                                                 <div class="col-md-3">
                                                     <div class="form-group">
                                                         <label class="form-label fw-bold text-dark">No.of Products</label>
                                                         <div id="clothing">
                                                 ...
                                                 <div class="col-md-3">
                                                     <div class="form-group">
                                                         <label class="form-label fw-bold text-dark">Add Product Informations</label>
                                                         <div id="clothing">
            ...
            <form action="{{ route('vendorproducts.crud.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row product-adding">
                    ...
                    @for($i=1;$i<=$nproduct;$i++)
                        ...
                        <div class="card p-3">
                            <div class="card-header">
                                <label class="form-label fw-bold text-dark fs-5">Product {{ $i }} Informations</label>
                            </div>
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group p-1">
                                            <label class="form-label fw-bold text-dark" style="color:blue">(Upload Format : jpg, jpeg, png, web) <span class="text-danger">*</span></label>
