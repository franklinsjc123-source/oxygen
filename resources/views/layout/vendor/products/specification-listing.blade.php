...
@section('contents')
                                        ...
                                        @foreach ($specification as $specification)
                                            <tr>
                                                ...
                                                <td>
													...
													<form
																action="{{ route('vendorproduct.specification.destroy', $specification->id) }}"
																method="post">
																@method('DELETE')
																@csrf
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" method="post" action="{{ route('vendorproduct.specification.store') }}"
                         ...
                         <div class="form">
                             ...
                             <div class="form-group">
                                 ...
                                 <select name="editcategory_sub_id" id="editcategory_sub_id" class="custom-select form-control" required>
                                     <option id="1" value="1" hidden selected>ALL</option>
    ...
    function showModal() {
        ...
        $(document).on('submit','#UPDATEFORM', function(e){
            ...
            var url ="{{route('vendorspecupdate', ":updatecate_id")}}";
