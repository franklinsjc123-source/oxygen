	...
	<!-- Right sidebar Ends-->
		...
		<div class="container-fluid">
			<div class="card tab2-card">
				...
				<form action="{{ route('vendorattribute.master.update', $group->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="attribute_group_name" class="form-label">Group Name</label>
            <input type="text" class="form-control" id="attribute_group_name" name="attribute_group_name" value="{{ $group->attribute_group_name }}" required readonly>
        </div>
        <div class="mb-3">
            <label for="attribute_group_refname" class="form-label">Reference Name</label>
            <input type="text" class="form-control" id="attribute_group_refname" name="attribute_group_refname" value="{{ $group->attribute_group_refname }}" required readonly>
        </div>
        <div class="mb-3">
            ...
            <div class="border p-3 rounded" style="max-height: 400px; overflow-y: auto;">
                @php
                    ...
                    $isAdminGroup = ($group->created_byid != $login_id);
