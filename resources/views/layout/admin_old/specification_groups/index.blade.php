...
<div class="page-body-wrapper">
            ...
            @endphp
                <tr>
                    ...
                    @php
                        ...
                        {
                        $i=1;
                        $nspc=($attr_val!='')?count($attr_val):0;
                        echo '<p>';
                    ...
                    <td style="white-space: nowrap; width: 1%;">
                        <div style="display: flex; gap: 5px; align-items: center;">
                            ...
                            <a href="{{ route('specification_groups.edit', $group->id) }}" class="btn btn-warning btn-sm" title="Edit" style="margin: 0;"><i class="fa fa-edit"></i></a>
                            
                            <form action="{{ route('specification_groups.destroy', $group->id) }}" onsubmit="return confirm('Are you sure, you want to delete it?')"method="POST" style="display:inline; margin: 0;">
                                @csrf
                                @method('DELETE')
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" method="post"   action="{{ route('update_specification') }}"             
    ...
    $('#exampleModal1').modal('show');
                     ...
                     //alert(response.subcategory[0].specification_name);
