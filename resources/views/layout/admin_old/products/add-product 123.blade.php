     ...
     $(document).ready(function() {
        // $('#sub_category').on('change', function() {
            ...
            getAjaxValue(url1, method1, function(data) {
                ...
                // <input type="hidden" name="specify_act[${spec.id}" value="insert">
