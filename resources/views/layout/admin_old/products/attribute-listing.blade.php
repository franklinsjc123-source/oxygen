                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <h5 class="fw-bold">Main Category</h5>
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                          ...
                                          <div class="col-md-3" style="margin-top:35px;">
                                                ...
                                                <button class="btn btn-primary" type="submit" name ="submit">Search</button>
                                                 <a href="{{ route('attribute.master.index') }}"class="btn btn-primary" type="submit" name ="submit">clear</a>
                                          </div>
                                        ...
                                        @php $spc++; @endphp
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	<form action="{{ route('attribute.master.destroy', $attribute->id) }}"
																method="post">
																@method('DELETE')
																@csrf
...
/*Edit Attripute*/ 
    ...
    $.ajax({
        //   data: $('').serialize(),  {{ url('admin/pincode1') }}/"+pin_id+"/edit"
          url: "{{ url('admin/editattribute') }}/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    function showModal() {
        ...
        $(document).on('submit','#UPDATEFORM', function(e){
            ...
            var url ="{{route('attributeupdate', ":updatecate_id")}}";
