                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-md-8">
                                ...
                                <!--                <input id="startdate" name="startdate" type="date" class="form-control" value="{{$offer->ActiveStartDate}}"-->
                                ...
                                <!--                <input id="enddate" name="enddate" type="date" class="form-control" value="{{$offer->ActiveEndDate}}"-->
                                <!--                    placeholder="dd/mm/yy" />-->
                                <!--            </div>-->
                ...
                <div class="form-group row ">
                    <div class="text-center">
                        <div class="col-xl-8 col-md-8">
                            ...
                            <a href="{{route('offer.main.index')}}" class="btn btn-secondary" type="button">Close</a>
                        </div>
                    </div>
                    </form>
                </div>
