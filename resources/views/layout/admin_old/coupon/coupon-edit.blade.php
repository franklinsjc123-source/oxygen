				...
				<div class="card-body">
					...
					@csrf
								...
								<div class="row">
									...
									<!--			 <input id="example" value="{{$coupon->start_date}}" name="start_date" type="date" value="" class="form-control"/>-->
									<!--			 </div>-->
									<!--			 <div class="col-md-3">											-->
									<!--			 </div>-->
									<!--		</div>-->
									...
									<!--			 <input id="example1" name="end_date" value="{{$coupon->end_date}}" type="date" class="form-control"  />-->
									<!--			 </div>-->
									<!--			 <div class="col-md-3">											-->
									<!--			 </div>-->
									<!--		</div>											-->
