		...
		<div class="container-fluid">
			<div class="card tab2-card">
				...
				<div class="card-body">
							...
							<form class="needs-validation" action="{{route('staffauction.update',$auction->id)}}" method="post" novalidate="" >
								@csrf
								@method('PUT')
								<div class="row fw-bold">
									<div class="col-sm-12">
									    ...
									    <div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="validationCustom1" name="start_price" value="{{$auction->start_price}}" type="text" required="" >
											</div>											
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="validationCustom0" name="slab" value="{{$auction->slab}}" type="text" required="">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="validationCustom1" name="bid_price" value="{{$auction->bid_price}}" type="text" required="" >
											</div>											
										</div>
