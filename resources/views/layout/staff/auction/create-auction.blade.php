		...
		<div class="container-fluid">
			<div class="card tab2-card">
				...
				<div class="card-body">
							...
							<form class="needs-validation" action="{{route('staffauction.store')}}" method="post" novalidate="" >
								@csrf
								@method('POST')
								<div class="row fw-bold">
									<div class="col-sm-12">
									    ...
									    <div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="validationCustom1" name="start_price" type="text" required="" >
											</div>											
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="validationCustom0" name="slab" type="text" required="">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="validationCustom1" name="bid_price" type="text" required="" >
											</div>											
										</div>
