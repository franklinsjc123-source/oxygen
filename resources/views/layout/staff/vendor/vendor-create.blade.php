                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div id="map" style="height: 450px; width: 100%; border-radius: 8px; z-index: 1;"></div>
                                                            <p class="mt-2 text-muted">Click on the map or drag the blue marker to set the vendor's precise location.</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-primary" data-dismiss="modal">Confirm & Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
