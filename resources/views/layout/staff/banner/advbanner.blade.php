                                        ...
                                        <div class="modal-dialog modal-dialog-centered" style="max-width: 550px;" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="{{route('staffadvbanner.store')}}" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data" >
                                                        @csrf
                                                        <div class="form">
                                    ...
                                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" style="max-width: 550px;" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="{{route('staffadvbanner.update', 0)}}" method="post" onsubmit="return confirm('Are you sure, you want to Update it?')" enctype="multipart/form-data" >
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="form">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="d-flex">
                                                  ...
                                                  <form
                                                     action="{{ route('staffadvbanner.destroy', $item->id) }}"
                                                     method="post">
                                                     @method('DELETE')
                                                     @csrf
...
<script>
    $(document).on('click', '.edit_advbaner', function(e){
        ...
        var url = "{{route('staffeditadvbanner', ":ad_id")}}";
