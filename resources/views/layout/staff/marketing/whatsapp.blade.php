									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="{{route('staffwhatsapp.store')}}" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data">
													@csrf
								...
								<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="{{route('staffwhatsapp.update', 1)}}" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data">
													@csrf
													@method('PUT')
													<div class="row fw-bold">
														<div class="col-sm-12">
                            	...
                            	<table class="table" id="table"  data-click-to-select="true" data-show-columns="true" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-sort="true" data-pagination="true" data-page-size="25" data-search="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true" data-cookie="true"
									...
									<tr>
										...
										<td><span class="d-flex">
											...
											<form
											action="{{ route('staffwhatsapp.destroy', $item->id) }}"
											method="post">
											@method('DELETE')
											@csrf
...
<script>
    $(document).on('click', '.edit_facebook', function(e){
		...
		console.log(ad_id);
        var url = "{{route('staffwhatsapp.edit', ":ad_id")}}";
