                                ...
                                <table class="table fcolor" id="table" data-click-to-select="true" data-sort-name="id"
                                    ...
                                    <thead>
                                        <tr class="">
                                            ...
                                            <th style="width: 10%" data-field="PId" data-sortable="true">VENDOR Id</th>
                                       ...
                                       {{-- @dd($offers); --}}
                                        @foreach ($products_list as $products)
                                            <tr>
                                                ...
                                                <td><?php  $vendorcreate = App\Models\vendor\vendorcreate::where('id', $products->login_id)->first(); ?>#{{ $vendorcreate->id }} ( {{ $vendorcreate->shop_name }})</td>
                                                ...
                                                <td class="text-center">
                                                    <span class="fw-bold">
                                                        <a  data-id={{ $products->id }}
                                                            class="text-danger productDetails" 
                                                            {{-- data-bs-toggle ="modal" data-original-title="test" data-bs-target="#stockModal" --}}
                                                            >{{ $products->vendor_product_details_cnt }}</a>
                                                    </span>
                                                </td>
                                               ...
                                               <td>
                                                    <div class="mt-2 d-flex">
                                                        <a href="{{ route('vendor_products.admin.view',  ['id'=>$products->id, 'sub_id'=>$products->category_sub,]) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".productDetails").click(function() {
                ...
                let url = '{{ route('getvendorProductDetails') }}?product_id=' + product_id;
