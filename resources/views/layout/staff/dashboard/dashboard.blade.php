        ...
        <div class="container-fluid mt-4">
            <div class="activity-tracker-container">
                ...
                <div class="mobile-view-all">
                    <a href="{{ url('staff/activity_trackers') }}" class="view-all-mobile-btn">View All &gt;&gt;</a>
                </div>
            </div>
        </div>
...
function fetchFilteredData(params) {
    var url = new URL("{{ route('staff.dashboard.filter_data', $vendorid) }}", window.location.origin);
