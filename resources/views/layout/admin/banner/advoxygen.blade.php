                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <li class="breadcrumb-item active">Oxygen Adv</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" style="max-width: 550px;" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Oxygen Adv</h5>
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="{{route('advoxygen.store')}}" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data" >
                                                        ...
                                                        <div class="form">
                                                            ...
                                                            <div class="form-group">
                                                                 <label for="validationCustom02" class="mb-1"> Image (612 X 180) :</label>
                                                    ...
                                                    <form class="" id="editForm" data-route="{{ route('advoxygen.update', ['advoxygen' => '__id__']) }}" method="post" onsubmit="return confirm('Are you sure, you want to Update it?')" enctype="multipart/form-data" >
                                                        ...
                                                        <div class="form">
							                    		  ...
							                    		  <!--  <div class="form-group row">-->
							                    				<!--<div class="col-md-6">-->
							                    				<!--<label class="">End Date / Time</label>-->
							                    				<!--	 <input id="editend_date" type="date" class="form-control" name="editend_date" id="editend_date" placeholder="dd/mm/yy"  />-->
							                    				<!--	 </div>-->
                                ...
                                <table class="table" id="table"  data-click-to-select="true"  data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-show-columns="true" data-sort="true" data-pagination="true" data-page-size="25" data-search="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <img src="{{asset('assets/images/banners/advoxygen') . '/' .$item->image}}" alt="" class="img-fluid img-30 me-2 blur-up lazyloaded">
                                                </div>
                                            </td>
                                            <td style="width:100%;">
                                             {{$item->title}}
                                            ...
                                            <td>
                                                <span class="d-flex">
                                                  ...
                                                  @if (session()->get('log_type') == 'Admin')
													  <form
                                                     action="{{ route('advoxygen.destroy', $item->id) }}"
                                                     method="post">
                                                     @method('DELETE')
                                                     @csrf
...
$(document).ready(function() {
    ...
    $(document).on('change', '.toggle-status', function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('advoxygen.changestatus') }}",
...
<script>
    $(document).on('click', '.edit_advbaner', function(e){
        ...
        var url = "{{route('editadvoxygen', ":ad_id")}}";
            ...
            $.ajax({
             ...
             success: function (response) {
               ...
               $('successmessage').text(response.message);
                ...
                let bannerId = response.adbanner.id;
                // let updateUrl = `/advoxygen/update/${bannerId}`; // or use route name if needed

                // Get the route template from the form's data attribute
                // let routeTemplate = $('#editForm').data('route'); // e.g., "/advoxygen/update/__id__"

                // Replace the placeholder with the actual ID
                // let updateUrl = routeTemplate.replace('__id__', bannerId);

                // Set the form action
                var testupdateUrl = "{{route('advoxygen.update', ":bannerId")}}";
                updateUrl = testupdateUrl.replace(":bannerId", bannerId);
...
//       //    console.log(pin_id);
//       $('#exampleModal1').modal('show');
//       var url ="{{route('editadvoxygen', ":cate_id")}}";
