                ...
                <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 550px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">												
                            <form class="" action="{{route('main_slider.store')}}" method="post" enctype="multipart/form-data" >
                                @csrf
                                <div class="form">
            ...
            <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 550px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">												
                            <form class="" action="{{route('main_slider.update', 0)}}" method="post" enctype="multipart/form-data" >
                                @csrf
                                @method('PUT')
                                <div class="form">
