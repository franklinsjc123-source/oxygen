...
@section('contents')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-popup pull-right">
                                    ...
                                    <a href="{{ route('zone.export') }}" class="btn btn-success px-2 " data-toggle="tooltip" data-placement="top" title="Report" data-original-title="Report"><i
                                                        ...
                                                        <button type="button" class="edit_zonal btn btn-secondary mx-1" value="{{$data->id}}">
                                                         <i class="fa fa-pencil"></i></button>
                                                                   ...
                                                                   @if (session()->get('log_type') == 'Admin')
																	   <form
                                                                    action="{{ route('zonaldelete', $data->id) }}"
                                                                    method="post">
                                                                    @method('POST')
                                                                    @csrf
    ...
    $.ajax({
        //   data: $('').serialize(),  {{ url('admin/pincode1') }}/"+pin_id+"/edit"
          url: "{{ url('admin/editzonal') }}/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    $.ajax({
        //   data: $('').serialize(),    {{ url('admin/zonalupdate') }}/"+id+"/update"
             // url: "{{ url('admin/zonalupdate') }}/"+updateid,
              //console.log(id);
              url: "{{ url('admin/zonalupdate') }}/"+id+"/update",
