     ...
     <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                ...
                                <div class="btn-popup pull-right">
                                    <div class="modal fade" id="exampleModalImport" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Upload Pincode <a href="{{asset('assets/img/sample_pincode.csv')}}" class='btn btn-primary' download> Sample Format Download </a></h5>
                                                    <button class="btn-close" type="button" data-bs-dismiss="modal"
                                                        aria-label="Close"><span aria-hidden="true">×</span></button>
                                                </div>
                                                <div class="modal-body">
                                                        ...
                                                        <div class="form">
                                                            ...
                                                            <!--<div class="form-group">
                                                                <label for="validationCustom02"
                                                                    class="mb-1">Zone</label>
                                                                <select class="custom-select w-100 form-control"
                                                                    required="true" id="imzone_id" name="zonal_id">
                                                                    <option value="">--Select Zone--</option>
                                                                     @foreach($zone as $z){
                                                                        <option value="{{$z->id}}">{{$z->name}}</option>
                                                                    }
                                                            ...
                                                            <div class="form-group">
                                                                <label for="validationCustom02"
                                                                    class="mb-1">Route</label>
                                                                <select class="custom-select w-100 form-control"
                                                                    required="true" name="route_id" id="imroute_id">
                                                                    <option value="">--Select Route-- </option>
                                                                    <!--@foreach($rdata as $d){-->
                                                                    <!--    <option value="{{$d->id}}">{{$d->name}}</option>-->
                                                                    <!--}-->
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <table class="table" id="table" data-click-to-select="true"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-field="id" data-sortable="true">SNO</th>
                                        ...
                                        @if($pincode)
                                            @foreach ($pincode as $pin)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switch">
                                                            <input type="checkbox" class="toggle-status" data-id="{{ $pin->id }}" {{ $pin->status == 1 ? 'checked' : '' }}>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.toggle-status', function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('pincode1.changestatus') }}",
    ...
    $(document).on('submit', 'form', function(e) {
        if($(this).find('input[name="_method"][value="DELETE"]').length > 0) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You want to delete this pincode! This cannot be undone.",
                icon: 'warning',
