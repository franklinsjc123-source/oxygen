                    ...
                    <div class="col-xl-12">
                        <div class="card tab2-card">
                            <div class="card-body">
								...
								<form action="{{ route(request()->is('staff/*') ? 'staffactivity_trackers.store' : 'activity_trackers.store') }}" method="POST">
								@csrf
...
<div class="row">
										...
										<div class="form-group row">
											...
											<div class="col-xl-8 col-md-8">
												...
												<span class="invalid-feedback-msg mobile-length-msg">Please enter a valid 10-digit mobile number</span>
