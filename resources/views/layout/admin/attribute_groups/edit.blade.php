	...
	<!-- Right sidebar Ends-->
		...
		<div class="container-fluid">
			<div class="card tab2-card">
				...
				<form action="{{ route('attribute_groups.update', $group->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="attribute_group_name" class="form-label">Group Name</label>
            <input type="text" class="form-control" id="attribute_group_name" name="attribute_group_name" value="{{ $group->attribute_group_name }}" required>
        </div>
        <div class="mb-3">
            <label for="attribute_group_refname" class="form-label">Reference Name</label>
            <input type="text" class="form-control" id="attribute_group_refname" name="attribute_group_refname" value="{{ $group->attribute_group_refname }}" required>
        </div>
        <div class="mb-3">
