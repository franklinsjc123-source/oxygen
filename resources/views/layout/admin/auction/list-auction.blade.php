                ...
                <div class="row">
                          ...
                          @endif
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('import') }}"
                                            ...
                                            <a href="{{ asset('assets/sample/auction_sample.csv') }}" class="btn btn-info ms-2" download="auction_sample.csv">
                    ...
                    <tr>
                        ...
                        <td><span class="mt-3 d-flex">
                          ...
                          @if(isset($title) && $title === 'Live Auction')
                          <a href="javascript:void(0)" class="btn btn-info px-3 mx-1 view-bids-btn" onclick="openBidsModal({{ $item->id }}, '{{ addslashes($item->product->product_name ?? 'N/A') }}')"><i class="fa fa-eye"></i> View Bids</a>
                          @endif
...
$(document).ready(function() {
    // Countdown Timer logic for Live Auction
