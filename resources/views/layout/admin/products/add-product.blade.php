                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" name="nproduct" value="1">
                                                <div class="col-md-3 d-flex align-items-end">
                                                    <div class="form-group w-100">
                                                        <button type="submit" class="btn btn-primary w-100 fw-bold py-2 mb-1"><i class="fa fa-plus"></i> ADD INFORMATIONS</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-xl-12 d-flex justify-content-end mb-4">
                        ...
                        <div class="d-inline px-2 text-white" style="width: 120px;">
                            <a href="{{ route('products.crud.listing') }}" class="btn btn-secondary w-100" type="button">Close</a>
                        </div>
                    </div>
                </div>
            </form>
