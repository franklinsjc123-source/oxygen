                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                            ...
                                                            <div id="clothing">
                                                                <select class="js-select2 form-control" name="category"
                                                                    ...
                                                                    {{-- <option value="" selected hidden>Select Main
                                                                        ...
                                                                        <option value="{{ $product->category }}" hidden> {{$cates['0']->category_name}}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div id="clothing">
                                                                <select class="js-select2 form-control" name="category_sub"
                                                                    ...
                                                                    <option value="  {{ $product->category_sub }}" hidden> {{ $cates['0']->category_sub_name }}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 digital-add needs-validation">
                                                ...
                                                @include('layout.admin.products.productviewDetails')
                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <option value="{{ $prspec->specify_attribute }}" hidden>
                                                                                ...
                                                                                <option value="{{ $prspec->specify_value }}" hidden>
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        ...
                                                                        <div class="col-md-3 ">
                                                                            <select class="form-select form-select-lg text-secondary"
                                                                                ...
                                                                                @endphp
                                                                                <option value="{{ $offer->id }}" {{ ($offerLabel == $product->offers || $offer->id == $product->offers)?'selected':'' }} hidden>
                                                                                    {{ $offerLabel }}
                                                                                </option>
                                                                                 @endforeach
                                                                        ...
                                                                        <div class="col-md-4 ">
                                                                            <select class="form-select form-select-lg text-secondary"
                                                                                ...
                                                                                <option hidden>{{ $product->collection }}</option>
