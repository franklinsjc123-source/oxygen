									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="{{route('facebook.store')}}" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')">
													@csrf
								...
								<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="{{route('facebook.update', 1)}}" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')">
													@csrf
													@method('PUT')
													<div class="row fw-bold">
														<div class="col-sm-12">
									...
									<tr>
										...
										<td><span class="d-flex">
											...
											@if (session()->get('log_type') == 'Admin')
												<form
											action="{{ route('facebook.destroy', $item->id) }}"
											method="post">
											@method('DELETE')
											@csrf
...
$(document).ready(function() {
    ...
    $(document).on('change', '.toggle-status', function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('facebook.changestatus') }}",
...
<script>
    $(document).on('click', '.edit_facebook', function(e){
		...
		console.log(ad_id);
        var url = "{{route('facebook.edit', ":ad_id")}}";
