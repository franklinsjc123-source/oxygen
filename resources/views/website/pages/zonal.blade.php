			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal"><i class="fa fa-plus"></i> Add Zonal</button>
												...
												<form class="" method="post" onsubmit="return confirm('Are you sure, you want to delete it?')" >
													...
													<div class="form">
														...
														<div class="form-group">
															<label for="validationCustom01" class="mb-1">Zonal Name :</label>
