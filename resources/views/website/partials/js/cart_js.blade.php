            ...
            if (data.sum == 0) {
                ...
                $.each(data.cart, function (i, item) {
                 ...
                 $('#addcart1_' + item.pid).hide();
                     ...
                     cart_dt+='<li> <div class="media"> <a href="#"><img alt="" class="me-3" src="' + itemImage + '"></a><div class="media-body"><a href="#"><h4>' + item.name + '</h4></a> <h4><span>1 x Rs ' + item.price + '</span></h4> </div></div> <div class="close-circle"><a href="#" onclick=deletecart("' + item.pid + '")><i class="fa fa-times" aria-hidden="true"></i></a></div></li>';
