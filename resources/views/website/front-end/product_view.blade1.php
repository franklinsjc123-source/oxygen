...
//  dd($product_det);
    ...
    <section>
        ...
        <div class="collection-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 collection-filter" style="margin-top:190px;">
                ...
                <div class="col-lg-9 col-sm-12">
                     ...
                     <div class="container-fluid p-0">
                      ...
                      <div class="row">
                            <div class="col-lg-6">
                                <div class="product-slick" style="margin-top:40px;">
                                    <?php 
                            ...
                            <div class="col-lg-6 rtl-text" style="margin-top:40px;">
