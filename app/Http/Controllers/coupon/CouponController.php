...
class CouponController extends Controller
{
    ...
    {
        $coupon = coupon::All();
        return view('layout.admin.coupon.coupon-create')->with('coupon', $coupon);
    ...
    public function couponlisting()
    {
       ...
       date_default_timezone_set('GMT');
        ...
        return view('layout.admin.coupon.list-coupon')
        ->with([
   ...
   //dd($coupon);
    ...
    public function edit($id)
    {
        ...
        return view('layout.admin.coupon.coupon-edit')
        ->with([
          "coupon"   => $coupon
        ]);
    }
...
//             ]);
        ...
        $coupon->minimum_requirment_amount=$request->minimum_requirment_amount;
         ...
         $coupon->status      =     $request->editstatus;
