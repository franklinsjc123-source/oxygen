    ...
    */ 
    ...
    public function update(Request $request, $id,FlasherInterface $flasher)
    {
      $IMAGE_PATH = "assets/images/productcollection";
        ...
        {   
            $pro_image = $request->file('editimage');
            
            $image=$productcollection->id."_image.".$pro_image->getClientOriginalExtension();
            
            $img = Image::make($pro_image->getRealPath());
        ...
        {
            $filename =$request->oldeditimage;
        }


        try {
            $productcollection->name = $request->editname;
            $productcollection->image = $filename ?? "-";
            $productcollection->status = $request->editstatus;
    ...
    public function listing()
    {
        ...
        return view("layout.admin.products.product-listing")->with("products_list", $products_list_arr);
    }
